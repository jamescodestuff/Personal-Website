...
import LB from "../public/assets/company/LB617.png";
    ...
    <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full">
      ...
      <VerticalTimeline className="bg-gray-200 ">
        ...
        >
          ...
          <p>
            ● Designed and deployed Live Boston 617's first news app, leveraging
            JavaScript and React Native to provide real-time crime updates to
            users.
            <br></br>● Utilized WordPress API to efficiently fetch HTTP requests
            and seamlessly integrate data into the mobile application.
            ...
            <br></br>● Revamped the UI and improved the overall user experience
            by introducing a Breaking News feature, showcasing the five most
            recent articles
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <p>
            ...
            <br></br>● Mentored and pivoted each member to optimize their skill
            and fostered continuous growth throughout the project.<br></br>●
            Facilitated weekly meetings, including sprint planning, code
            reviews, and deliverable write-ups with each developer to track
